...
ENSEMBL_VERSION=87
URL_FILE_CONTIG_EXCL="https://raw.githubusercontent.com/dellytools/delly/master/excludeTemplates/human.hg19.excl.tsv"

DIR_IN=/home/tgenref/homo_sapiens/grch37_hg19/hs37d5_suncity/gene_model/ensembl_v${ENSEMBL_VERSION}
EXPECTED_GTF_FILE=${DIR_IN}/Homo_sapiens.GRCh37.${ENSEMBL_VERSION}.gtf
DIR_OUT=/home/tgenref/homo_sapiens/grch37_hg19/hs37d5_suncity/gene_model/ensembl_v${ENSEMBL_VERSION}/tool_resources/delly
#DIR_OUT="."
...
echo -e "Downloading the GRCh37 contig exclusion file provided by Delly's Author ... (if file exists; otherwise Error and Manually intervention is required) "
