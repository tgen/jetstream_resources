...
echo >> README
echo "wget https://raw.githubusercontent.com/tgen/MMRF_CoMMpass/master/immunoglobulin_transcripts/Homo_sapiens_GRCh38_98_ucsc_ig_ENST_to_filter_out.tsv" >> README

wget https://raw.githubusercontent.com/tgen/MMRF_CoMMpass/master/immunoglobulin_transcripts/Homo_sapiens_GRCh38_98_ucsc_ig_ENST_to_filter_out.tsv
